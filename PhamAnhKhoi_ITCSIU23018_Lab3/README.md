...
> Notice: Make sure that you are at the folder `/PhamAnhKhoi_ITCSIU23018_Lab3/`.
> 
> For example: `E:\ForCoding\Artificial-Intelligent-Lab\PhamAnhKhoi_ITCSIU23018_Lab3>`
...
## Run the code
Change directory into `/Lab3`. Then type
```bash
python run_lab3.py
```
